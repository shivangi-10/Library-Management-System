<%@ Page Title="" Language="C#" MasterPageFile="~/librarian/librarian.Master" AutoEventWireup="true" CodeBehind="add_books.aspx.cs" Inherits="library_ms.librarian.add_books" %>
                                  ...
                                  <form action="" id="fo1" runat="server" method="post" novalidate="novalidate">
                                      ...
                                      <div>
                                       ...
                                       <div class="alert alert-success" id ="msg" runat="server" style="margin-top:10px; display:none">
                                            <strong>You books are added successfully!</strong>
                                       </div>
                                  </form>
                              </div>
                          </div>
